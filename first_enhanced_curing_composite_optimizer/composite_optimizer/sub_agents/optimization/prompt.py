...
if verifier() suggests some value change, DO IT as the it has to fall within ranges otherwise the simulation won't run. (You can mention the reasonining in the final Table). The last say on the values will ALWAYS be of the verifier()
